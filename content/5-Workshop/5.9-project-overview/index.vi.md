...
Ứng dụng gồm hai phần giao diện:

```text
Flutter app   → dùng cho Customer và Merchant
Admin Web     → dùng cho Admin
```
...
Admin Web: chạy qua Vite, kết nối cùng API Gateway endpoint với Flutter app.
